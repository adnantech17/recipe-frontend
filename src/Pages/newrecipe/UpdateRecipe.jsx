...
const NewRecipe = () => {
  ...
  useEffect(() => {
    setTags(objToStrArray(location.state.tags));
    setIngredients(objToStrArray(location.state.ingredients));
    setTitle(location.state.title);
    setTime(location.state.time);
    setPrice(location.state.price);
    fetchTags(objToStrArray(location.state.tags));
    fetchIngs(objToStrArray(location.state.ingredients));
  }, []);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    fetch(`/recipe/recipes/${location.state.id}/`, {
      method: "PATCH",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
